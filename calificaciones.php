...
<TD STYLE="WIDTH:50PX"><img src="imagenes/logo.png" wiDTH="200" height="160"></TD>
 ...
 <table>
  ...
  <th>
    </th><td><strong><font size="6">Administrar calificaciones</font></strong> <br>
    </td>
...
require("conexion.php");
            ...
            $query="SELECT *FROM vw_calificaciones LIMIT $empieza,$por_pagina";
          ...
          <table  cellpadding="7"  border="1" bgcolor="transparent" action>
            ...
            <tr align"center">
              ...
              <td><?php echo $fila['txtNombremat'];?></td>
              <td><?php echo $fila['txtCPrimerbi'];?></td>
              <td><?php echo $fila['txtCSegundobi'];?></td>
              <td><?php echo $fila['txtCTercerbi'];?></td>
              <td><?php echo $fila['txtCCuartobi'];?></td>
              
              <td><a href = "#?intidalumnos=<?=$fila['intidalumnos']?>">Modificar</a></td>
              <td><a href="#?intidalumnos=<?=$fila['intidalumnos']?>">Eliminar</a>
            </tr>
            <?php
            };
            ?>
          ...
          <div>
           <div>
            <?php
               ...
               $query="SELECT *FROM vw_calificaciones";
               $resultado=mysqli_query($conexion,$query);
               ...
               echo "<center><a href='calificaciones.php?pagina=1'>".' Primera '."</a>";
               for ($i=1;$i<=$total_paginas;$i++) {
                 echo "<a href='calificaciones.php?pagina=".$i."'>".$i."</a>";
               }
               echo "<a href='calificaciones.php?pagina=$total_paginas'>".' Ultima '."</a></center>";
            ?>
          </div>
        </center>
