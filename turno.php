...
<TD STYLE="WIDTH:50PX"><img src="imagenes/logo.png" wiDTH="200" height="160"></TD>
 ...
 <table>
  ...
  <th>
    </th><td><strong><font size="6">Administrar turno</font></strong> <br>
    </td>
...
<form  name="frmmateria" method="post"  action="registrarturno.php">

<input type="submit" value="Agregar turno" class="button">
</form>
...
require("conexion.php");
            ...
            $query="SELECT *FROM tblturno LIMIT $empieza,$por_pagina";
          ...
          <table  cellpadding="7"  border="1" bgcolor="transparent" action>
            ...
            <tr align"center">
              ...
              <td><?php echo $fila['intidturno'];?></td>
              <td><?php echo $fila['txtDescripcionturno'];?></td>
              
              <td><a href = "actualizaturno.php?intidturno=<?=$fila['intidturno']?>">Modificar</a></td>
              <td><a href="deleteturno.php?intidturno=<?=$fila['intidturno']?>">Eliminar</a>
            </tr>
            <?php
            };
            ?>
          ...
          <div>
           <div>
            <?php
               ...
               echo "<center><a href='turno.php?pagina=1'>".' Primera '."</a>";
               for ($i=1;$i<=$total_paginas;$i++) {
                 echo "<a href='turno.php?pagina=".$i."'>".$i."</a>";
               }
               echo "<a href='turno.php?pagina=$total_paginas'>".' Ultima '."</a></center>";
            ?>
          </div>
        </center>
