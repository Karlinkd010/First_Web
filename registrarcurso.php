...
<nav>
  ...
  <form id="form1" name="form1" method="post" action="agregacurso.php">
    <h1>Registrar cursos</h1>
     <br>
    

      <label>Grado</label><input type="text" name="grado"  size "22" required  maxlength="50" >
      <br>
       <label>Grupo</label><input type="text" name="grupo"  size "22" maxlength="50" required  >
      <br>
