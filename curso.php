...
<TD STYLE="WIDTH:50PX"><img src="imagenes/logo.png" wiDTH="200" height="160"></TD>
 ...
 <table>
  ...
  <th>
    </th><td><strong><font size="6">Administrar curso</font></strong> <br>
    </td>
...
<form  name="frmmateria" method="post"  action="registrarcurso.php">

<input type="submit" value="Agregar curso" class="button">
</form>
...
require("conexion.php");
            ...
            $query="SELECT *FROM cursoenactivo LIMIT $empieza,$por_pagina";
          ...
          <table  cellpadding="7"  border="1" bgcolor="transparent" action>
            ...
            <tr align"center">
              ...
              <td><a href = "actualizacurso.php?intidCurso=<?=$fila['intidCurso']?>">Modificar</a></td>
              <td><a href="deletecurso.php?intidCurso=<?=$fila['intidCurso']?>">Eliminar</a>
            </tr>
            <?php
            };
            ?>
          ...
          <div>
           <div>
            <?php
               ...
               echo "<center><a href='curso.php?pagina=1'>".' Primera '."</a>";
               for ($i=1;$i<=$total_paginas;$i++) {
                 echo "<a href='curso.php?pagina=".$i."'>".$i."</a>";
               }
               echo "<a href='curso.php?pagina=$total_paginas'>".' Ultima '."</a></center>";
            ?>
          </div>
        </center>
